...
TEMPLATES_DIR = Path.joinpath(BASE_DIR, "movie/templates/movie")
...
SECRET_KEY = '!06-@$q+m&w79cbox)#)2!k9x4pnon5exf#7_^jv$7a(z9ypt)'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # for Multilangauges website
